...
of;
places;
let placesToVisit = ['Machu picchu', 'Tokyo', 'Santorini', 'Banff Nationalpark', 'Cape Town',];
print;
the;
array in its;
origional;
...
order;
of;
list(modifies, the, origional, list);
...
the;
list;
again(back, to, origional, order);
placesToVisit.reverse();
console.log("Back to Origional order:", placesToVisit);
sort;
the;
array in alphabetical;
order(modifies, the, origional, list);
placesToVisit.sort();
